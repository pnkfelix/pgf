...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/utilities/pgfcalendar.code.tex,v 1.6 2007/02/10 17:50:20 tantau Exp $
...
\def\pgfcalendarifdate#1#2#3#4{%
  \edef\pgf@temp{#1}%
  \expandafter\pgfcalendar@split\pgf@temp\relax%
...
\def\pgfcalendar@between#1 and #2\relax{%
