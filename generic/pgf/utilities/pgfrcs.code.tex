...
\def\pgfversion{1.19}
\def\pgftypesetversion{\oldstylenums{1}.\oldstylenums{19}}
...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/utilities/pgfrcs.code.tex,v 1.19 2008/01/11 14:09:30 tantau Exp $
