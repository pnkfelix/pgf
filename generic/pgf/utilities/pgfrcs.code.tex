...
\def\pgfversion{1.18-cvs}
\def\pgftypesetversion{\oldstylenums{1}.\oldstylenums{18}--\textsc{cvs}}
...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/utilities/pgfrcs.code.tex,v 1.18 2007/12/20 19:16:31 tantau Exp $
