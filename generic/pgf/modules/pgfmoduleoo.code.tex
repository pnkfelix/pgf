...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleoo.code.tex,v 1.4 2008/05/19 09:31:26 tantau Exp $
...
\long\def\pgfooclass#1#2{%
  ...
  \expandafter\let\csname pgfooY\pgfoo@classname.@pgfooresetattributes\endcsname\pgfoo@attribute@collection%
...
\def\pgfoo@new#1=new #2(#3){%
  ...
  \else%
    ...
    \let#1\pgfoolastobj%
    \pgfoolastobj.@pgfooresetattributes()%
    \pgfoolastobj.#2(#3)%
  \fi%
}
