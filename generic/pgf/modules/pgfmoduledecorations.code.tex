...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduledecorations.code.tex,v 1.1 2008/01/15 10:27:34 tantau Exp $
...
\def\pgf@metadecoration@do@code{%
  ...
  \csname pgf@metadecoration@@\pgf@metadecoration@name @\pgf@metadecoration@current@state @code\endcsname%
  \pgf@decorate@invoke{%
  	{\pgf@decorate@tempname}{\pgf@metadecoration@width}{\pgf@decorate@tempbefore}{\pgf@decorate@tempafter}%
  }%
	%
  % Next iteration.
  %
...
\def\pgf@metadecoration@setter{\pgfqkeys{/pgf/meta decorate}}

\pgfkeys{
  /pgf/meta decorate/width/.code=\def\pgf@metadecoration@width{#1}\pgf@metadecoration@switch@if#1 to final\pgf@stop,%
  /pgf/meta decorate/switch if less than/.code=\pgf@metadecoration@switch@if#1\pgf@stop,%
  /pgf/meta decorate/switch if subpath less than/.code=\pgf@metadecoration@switch@ifsubpath#1\pgf@stop,%
  /pgf/meta decorate/next state/.store in=\pgf@metadecoration@next@state,%
}
