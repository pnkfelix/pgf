...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduledatavisualization.code.tex,v 1.7 2008/03/26 20:50:47 tantau Exp $
...
%      with the first command other that \par or \data (such as \end,
%      for instance).
%
% Description:
%
