...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduledatavisualization.code.tex,v 1.12 2008/06/13 08:16:27 tantau Exp $
...
\pgfooclass{interval}
{
  ...
  \method set min adjust absolute(#1) {
    \pgfooeset{min adjust absolute}{#1}    
  }
  \method set min adjust relative(#1) {
    \pgfooeset{min adjust relative}{#1}    
  }
  \method set max adjust absolute(#1) {
    \pgfooeset{max adjust absolute}{#1}    
  }
  \method set max adjust relative(#1) {
    \pgfooeset{max adjust relative}{#1}    
  }
