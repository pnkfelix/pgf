...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/modules/pgfmoduleshapes.code.tex,v 1.6 2008/11/13 17:29:21 tantau Exp $
...
\def\pgf@sh@resavedmacro#1#2{%
	...
	\def\addtosavedmacro##1{%
		...
		{\expandafter\toks@\expandafter{\pgf@sh@addtomacro@temp}\expandafter}%
