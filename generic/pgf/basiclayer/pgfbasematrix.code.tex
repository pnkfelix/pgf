...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/Attic/pgfbasematrix.code.tex,v 1.7 2007/01/04 00:02:09 tantau Exp $
...
\def\pgfmatrixnextcell{\pgfutil@ifnextchar[{\pgf@matrix@cell@cont}{\pgf@matrix@cell@cont[0pt]}}%}

\def\pgf@matrix@cell@cont[#1]{%
  \ifnum\pgfmatrixcurrentcolumn<\pgf@matrix@numberofcolumns%
  \else%
  {%
    \setlength\pgf@x{\pgfmatrixcolumnsep}%
    \setlength\pgf@xa{#1}%
...
\def\pgf@matrix@endcell{%
  ...
  \ifnum\pgfmatrixcurrentcolumn>1\relax%
    \setlength{\pgf@y}{\csname pgf@matrix@column@sep@\the\pgfmatrixcurrentcolumn\endcsname}%
