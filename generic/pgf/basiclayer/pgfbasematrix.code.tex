...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/Attic/pgfbasematrix.code.tex,v 1.5 2007/01/01 13:51:54 tantau Exp $
...
\def\pgf@matrix@endcell{%
    ...
    \ifnum\pgfmatrixcurrentrow=1\relax%
      \expandafter\xdef\csname pgf@matrix@column@sep@\the\pgfmatrixcurrentcolumn\endcsname{\pgfmatrixcolumnsep}%
    \fi%
  \egroup\egroup%
