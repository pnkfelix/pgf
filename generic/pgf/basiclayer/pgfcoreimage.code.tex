...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcoreimage.code.tex,v 1.3 2008/06/20 11:41:04 ludewich Exp $
...
\long\def\pgf@replacepicturebygraphic#1\endpgfgraphicnamed{%
	\pgfincludeexternalgraphics{\pgf@filename}\unskip
}
