...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcoreimage.code.tex,v 1.10 2010/02/01 11:22:12 ludewich Exp $
...
\def\pgfincludeexternalgraphics#1{%
	...
	\ifeof\r@pgf@reada
		\box1
	\else
		\read\r@pgf@reada to\pgfincludeexternalgraphics@dp
		\closein\r@pgf@reada
