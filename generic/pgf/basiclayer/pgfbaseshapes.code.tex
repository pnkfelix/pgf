\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/Attic/pgfbaseshapes.code.tex,v 1.8 2005/10/10 08:38:29 tantau Exp $
...
% \pgfnodefromboxes{rectangle}{center}{Hello}{hellonode}{\pgfusepath{stroke}}

\def\pgfnodefromboxes#1#2#3#4{%
    ...
    {%
      ...
      {%
        \expandafter\@for\expandafter\pgf@shape@com\expandafter:\expandafter=\csname pgf@sh@boxes@#1\endcsname\do{%
          \expandafter\pgf@shape@com@execute\pgf@shape@com{#1}%
        }%
      }%
...
\def\pgf@shape@com@execute#1#2#3{%
  \pgftransformshift{\pgf@sh@reanchor{#3}{#1}}%
  \pgfqboxsynced{#2}%
}
...
%
% - \boxes
%   List of anchors and TeX-boxes that make up the shape.
%
% Example:
%
...
\long\def\pgfdeclareshape#1#2{%
  {
    ...
    \let\inheritboxes=\pgf@sh@inheritboxes
    \anchorborder{\csname pgf@anchor@#1@center\endcsname}%
    \anchor{text}{\pgfpointorigin}%
    \boxes{{text}{\pgfshapebox}}%
