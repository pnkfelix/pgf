...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorescopes.code.tex,v 1.30 2010/06/30 10:25:08 ludewich Exp $
...
\def\endpgfpicture{%
              ...
              \pgf@process{\pgf@hbaseline}%
              \global\advance\pgf@x by-\pgf@picminx
              \xdef\pgf@hshift@baseline{-\the\pgf@x}%
            \endgroup%
            \hss%
          \egroup%
          \pgf@insertlayers%
...
\def\pgfsethbaselinepointlater#1{\def\pgf@hbaseline{#1}}
\def\pgfsethbaselinepointnow#1{%
  \pgf@process{#1}%
  \edef\pgf@setter@baseline{\noexpand\pgfpoint{\the\pgf@x}{\the\pgf@y}}%
  \pgfsethbaselinepointlater{\pgf@setter@baseline}%
}
\def\pgfsethbaseline#1{\pgfsethbaselinepointlater{\pgfpoint{#1}{0pt}}}
\pgfsethbaseline{\pgf@picminx}
