...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorearrows.code.tex,v 1.10 2008/04/22 17:03:26 tantau Exp $
...
\def\pgf@arrow@call#1{%
  \expandafter\ifx\csname pgf@arrow@prot@#1@\the\pgflinewidth @\pgfinnerlinewidth\endcsname\relax%
    ...
    {%
      ...
      \expandafter\global\expandafter\let\csname pgf@arrow@prot@#1@\the\pgflinewidth @\pgfinnerlinewidth\endcsname=\pgf@temp%
    }%
    \pgfsysprotocol@setcurrentprotocol\pgf@arrow@temp%
  \fi%
  \csname pgf@arrow@prot@#1@\the\pgflinewidth @\pgfinnerlinewidth\endcsname%
} 
