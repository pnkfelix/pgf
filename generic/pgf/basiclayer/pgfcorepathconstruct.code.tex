...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorepathconstruct.code.tex,v 1.23 2010/08/03 12:09:43 ludewich Exp $
...
\def\pgfpatharctoprecomputed#1#2#3#4#5#6#7#8{%
	...
	\ifdim\pgf@xa>\pgf@xb
		...
		\pgf@xa=\pgf@xb
		\pgf@xb=\pgf@xc
		\edef\pgfpath@completearcend{\global\pgf@x=\the\pgf@path@lastx\global\pgf@y=\the\pgf@path@lasty\space}%
		\pgfpathmoveto{#4}%
	\fi
	\edef\pgfpath@startangle{\the\pgf@xa}%
