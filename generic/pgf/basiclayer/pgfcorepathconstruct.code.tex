...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorepathconstruct.code.tex,v 1.10 2007/07/23 21:23:14 tantau Exp $
...
\pgfkeys{
  /pgf/stepx/.cd,.code=\pgfmathsetlength{\pgf@x}{#1},.value required,
  /pgf/stepy/.cd,.code=\pgfmathsetlength{\pgf@y}{#1},.value required,
  /pgf/step/.cd,.code=\pgf@process{#1},.value required
}

\def\pgfpathgrid{\pgfutil@ifnextchar[{\pgf@pathgrid}{\pgf@pathgrid[]}}
\def\pgf@pathgrid[#1]#2#3{%
  \pgfset{stepx=1cm,stepy=1cm,#1}%
  \pgf@xc=\pgf@x%
  \pgf@yc=\pgf@y%
  \pgf@process{#3}%
  \pgf@xb=\pgf@x%
