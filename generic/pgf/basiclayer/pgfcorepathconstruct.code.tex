...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorepathconstruct.code.tex,v 1.7 2007/02/05 11:23:22 tantau Exp $
...
\def\pgf@@arc#1#2#3/#4\@@{%
  ...
  \else%
    \advance\pgfutil@tempcnta by -90\relax%
  \fi%
  \pgfpointtransformed{\pgfpointpolar{\pgfutil@tempcnta}{\@tempdima/\@tempdimb}}%
  ...
  \pgfutil@tempcnta=#1\relax%
  \pgfpointtransformed{\pgfpointpolar{\pgfutil@tempcnta}{#3/#4}}%
