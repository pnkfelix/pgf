...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcorepathconstruct.code.tex,v 1.8 2007/03/09 17:49:32 tantau Exp $
...
\def\pgf@@arc#1#2#3and #4\@@{%
  \pgfmathsetlength{\@tempdima}{#3}%
  \pgfmathsetlength{\@tempdimb}{#4}%
  ...
  \else%
    ...
    \fi%
  \fi
  \@tempdima=\pgfutil@tempcntb\@tempdima\relax%
  \divide\@tempdima by 9\relax%
  \@tempdimb=\pgfutil@tempcntb\@tempdimb\relax%
  \divide\@tempdimb by 9\relax%
  %.. controls +(\pgfutil@tempcnta+90:\@tempdima) and +(\pgfutil@tempcntb-90:\@tempdima) .. +(-(#1:#3)+(#2:#3))%
  ...
  \else%
    \advance\pgfutil@tempcnta by -90\relax%
  \fi%
  \pgfpointtransformed{\pgfpointpolar{\pgfutil@tempcnta}{\@tempdima and \@tempdimb}}%
