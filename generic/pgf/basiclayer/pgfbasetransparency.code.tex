...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/Attic/pgfbasetransparency.code.tex,v 1.2 2007/12/13 18:40:19 tantau Exp $
...
% used.  
%
% If no rotation occurs, the lower left corner of the path will lie on
% (25bp, 25bp), the upper right corner on (75bp, 75bp).
%
% Example:
%
