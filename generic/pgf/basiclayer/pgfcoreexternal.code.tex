...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcoreexternal.code.tex,v 1.4 2010/06/10 08:59:24 ludewich Exp $
...
% Defines \pgfretval to be the depth of the external picture '#1'.
%
