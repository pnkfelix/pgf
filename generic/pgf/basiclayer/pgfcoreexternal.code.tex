...
\ProvidesFileRCS $Header: /cvsroot/pgf/pgf/generic/pgf/basiclayer/pgfcoreexternal.code.tex,v 1.14 2010/08/31 06:57:34 ludewich Exp $
...
\long\def\pgfincludeexternalgraphics@read@dpth@line#1{%
    \pgfutil@ifnextchar\bgroup{%
        \def\pgfexternal@nextisbraced{1}% the braces must be re-inserted when copied to the main aux file.
        \pgfincludeexternalgraphics@read@dpth@line@#1%
    }{%
        \def\pgfexternal@nextisbraced{0}%
        \pgfincludeexternalgraphics@read@dpth@line@#1%
    }%
}%
