\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.21 2005/09/05 21:46:56 tantau Exp $
...
\define@key{tikz}{wave amplitude}{\setlength{\pgfsnakewaveamplitude}{#1}}
\define@key{tikz}{wave length}{\setlength{\pgfsnakewavelength}{#1}}
\define@key{tikz}{wave angle}{\def\pgfsnakewavesangle{#1}}

\define@key{tikz}{object distance}{\def\pgfsnakeobjectdistance{#1}}
\define@key{tikz}{object size}{\def\pgfsnakeobjectsize{#1}}
