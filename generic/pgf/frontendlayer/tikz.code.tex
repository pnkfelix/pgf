\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.17 2005/08/29 20:57:25 tantau Exp $
...
% Syntax for trees:
% node {...} child [options] { node ... } child [options] {node ...}
...
\def\tikz@collect@child hild{%
  ...
  \expandafter\def\expandafter\tikz@children@list\expandafter{\tikz@children@list \tikz@childnode}%
  \@ifnextchar[{\tikz@collect@child@opt}{\tikz@collect@child@opt[]}}%}
\def\tikz@collect@child@opt[#1]{%
...
\def\tikz@childnode[#1]#2{%
  ...
  \@ifnextchar[\tikz@childnode@opt{\tikz@childnode@opt[]}[#1]#2;}%}
