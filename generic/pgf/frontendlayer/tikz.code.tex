...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.71 2007/01/01 13:51:54 tantau Exp $
...
\tikzoption{active ampersand}[true]{\csname tikz@matrix@active@ampersand#1\endcsname}
\tikzoption{backslash ampersand}[true]{\csname tikz@matrix@backslash@ampersand#1\endcsname}

\newif\iftikz@is@matrix
\newif\iftikz@matrix@active@ampersand
\newif\iftikz@matrix@backslash@ampersand

\tikz@matrix@active@ampersandtrue
\tikz@matrix@backslash@ampersandtrue
      ...
      \hbox\bgroup\bgroup%
          \pgfinterruptpath%
            \pgfscope%
              \tikz@options%
              \setbox\tikz@figbox=\box\voidb@x%
              \edef\tikz@anchor{\tikz@anchor}%
              \expandafter\pgfutil@in@\expandafter{\expandafter.\expandafter}\expandafter{\tikz@anchor}%
              \ifpgfutil@in@%
                \expandafter\tikz@matrix@split\tikz@anchor\relax%
              \else%
              ...
              {\tikz@matrix@shift}%
              {%
                \iftikz@matrix@backslash@ampersand%
                  \pgfmatrixbackslashampersand%
                \fi%
                \iftikz@matrix@active@ampersand%
                  \pgfmatrixactiveampersand%
                \fi%
                \def\pgfmatrixbegincode{\scope[every cell]\tikz@atbegin@cell}
                \def\pgfmatrixendcode{\tikz@atend@cell\endscope}
