\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.42 2006/03/01 23:57:34 tantau Exp $
...
\define@key{tikz}{pattern}{%
  \pgfifpatterniscolored{#1}
    {\tikz@addoption{\pgfsetfillpatterncolored{#1}}}
    {\tikz@addoption{\pgfsetfillpatternuncolored{#1}{\tikz@pattern@color}}}%
}
