...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.101 2007/12/12 16:57:17 tantau Exp $
...
\def\tikz@finish{%
  ...
  % Rendering pipeline:  
  % 
  % Step 0: Do a fade if necessary
  %
  \iftikz@mode@fade%
    \pgfsetfadingforcurrentpath{\tikz@fading}{\tikz@fade@angle}%
