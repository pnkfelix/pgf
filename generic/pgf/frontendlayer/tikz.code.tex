...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.104 2007/12/14 22:23:25 tantau Exp $
...
\tikzoption{fading transform}{\def\tikz@fade@transform{#1}}
\def\tikz@do@fade@transform{\let\tikz@transform=\relax\expandafter\tikzset\expandafter{\tikz@fade@transform}}
\tikzset{fading angle/.style={fade,fading transform={rotate=#1}}}
...
\def\tikz@scope@fade{%
  ...
  \else%
    \path%
      \tikz@scope@fading@bb%
      \pgfextra{\pgfsetfadingforcurrentpath{\tikz@scope@fading}{\tikz@do@fade@transform}};%
  \fi%
  \let\tikz@scope@fading=\pgfutil@empty%
}
...
\def\tikz@finish{%
  ...
  \iftikz@mode@fade%
    \tikz@addoption{%
      \pgfsetfadingforcurrentpath{\tikz@fading}{\tikz@do@fade@transform}%
