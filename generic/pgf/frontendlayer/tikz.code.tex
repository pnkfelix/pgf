...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.92 2007/07/20 08:31:12 tantau Exp $
      ...
      {%
        ...
        \else%
          ...
          \expandafter\ifx\csname pgf@sh@s@\tikz@key\endcsname\relax%
            \pgfkeys{/errors/unknown key=\tikz@key{#1}}%
          \else%
...
\def\tikz@path@overlay#1{\pgfutil@ifnextchar<{\tikz@path@overlayed{#1}}{\path #1}}
