\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.53 2006/09/01 19:22:55 tantau Exp $
...
\tikzoption{step}{\def\tikz@grid@x{#1}\def\tikz@grid@y{#1}}
