\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.30 2005/10/11 09:33:37 tantau Exp $
...
\def\tikz@nodepart@continue{%
  ...
  \expandafter\setbox\csname pgf@nodepartbox@\tikz@nodepart@name\endcsname=\hbox%
      \bgroup%
        \pgfinterruptpicture%
          \ifx\tikz@text@width\@empty%
          \else%
