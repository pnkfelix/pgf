...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.82 2007/04/19 11:57:08 tantau Exp $
...
%  \@tempdima#1\@tempdima\tikz@unique%
  \pgfmathparse{#1}%
  \let\iftikz@isdimension=\ifpgfmath@unitsdeclared%
}
