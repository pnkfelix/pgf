\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.12 2005/08/24 17:38:25 tantau Exp $
    ...
    \hbox\bgroup\bgroup%
        \pgfinterruptpath%
          \pgfscope%
            ...
            \pgf@xc=1cm%
            \pgf@xb=1cm%
            \pgf@xb=\c@pgf@counta\pgf@xb%
            \advance\pgf@xb by-1cm%
            \pgf@xb=.5\pgf@xb%
...
\def\tikz@endchild{%
            \draw (\tikz@root) -- (\tikz@last@fig@name);
        \endpgfscope
      \endpgfinterruptpath%
    \egroup\egroup%
  \egroup%
