\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.22 2005/09/06 08:12:48 tantau Exp $
...
\tikzstyle{snake triangle 45}=      [snake=triangle,segment object length=2.41421356\pgfsnakesegmentamplitude]
\tikzstyle{snake triangle 60}=      [snake=triangle,segment object length=1.73205081\pgfsnakesegmentamplitude]
\tikzstyle{snake triangle 90}=      [snake=triangle,segment object length=\pgfsnakesegmentamplitude]
