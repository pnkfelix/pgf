\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.54 2006/09/04 15:01:29 tantau Exp $
...
\tikzoption{after node path}{\expandafter\def\expandafter\tikz@after@node\expandafter{\tikz@after@node#1}}
...
\def\tikz@node@distance{2cm}

\tikzoption{above of}{\def\tikz@anchor{south}\tikz@of{#1}{90}}%
\tikzoption{below of}{\def\tikz@anchor{north}\tikz@of{#1}{-90}}%
\tikzoption{left of}{\def\tikz@anchor{east}\tikz@of{#1}{180}}%
\tikzoption{right of}{\def\tikz@anchor{west}\tikz@of{#1}{0}}%
\tikzoption{above left of}{\def\tikz@anchor{south east}\tikz@of{#1}{135}}%
\tikzoption{below left of}{\def\tikz@anchor{north east}\tikz@of{#1}{-135}}%
\tikzoption{above right of}{\def\tikz@anchor{south west}\tikz@of{#1}{45}}%
\tikzoption{below right of}{\def\tikz@anchor{north west}\tikz@of{#1}{-45}}%

\def\tikz@of#1#2{%
  \let\tikz@do@auto@anchor=\relax%
  \tikz@addtransform{\pgftransformshift{\pgfpointpolar{#2}{\tikz@node@distance}}}%
  \def\tikz@node@at{\pgfpointanchor{#1}{#2}}}
