\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/Attic/tikz.code.tex,v 1.46 2006/04/07 09:38:10 tantau Exp $
...
% Baseline options
\define@key{tikz}{baseline}[0pt]{\@ifnextchar({\tikz@baseline@coordinate}{\tikz@baseline@simple}#1\@nil}%)
