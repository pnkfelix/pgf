...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibrarypositioning.code.tex,v 1.3 2008/02/08 01:29:46 tantau Exp $
...
\tikzset{chain/.default=,
    ...
    \pgfkeysalso{/tikz/join/.code=\tikz@lib@parse@join{##1},/tikz/join/.default=}% only locally, to avoid clash with normal join
  },
