...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/tikzlibrarypositioning.code.tex,v 1.2 2008/02/08 01:17:06 tantau Exp $
...
\tikzset{chain/.default=,
    ...
    \tikzset{join/.code=\tikz@lib@parse@join{#1},join/.default=}% only locally, to avoid clash with normal join
  },
