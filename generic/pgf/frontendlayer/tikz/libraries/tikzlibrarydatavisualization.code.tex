...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/Attic/tikzlibrarydatavisualization.code.tex,v 1.7 2008/06/13 09:27:26 tantau Exp $
...
\tikzdatavisualizationset{
  new inspector/.style={
    new object={
      store=/tikz/data visualization/#1/interval,
      class=interval,
      arg1=,
      arg2=
    },
    new object={
      store=/tikz/data visualization/#1/inspector,
      class=inspector,
      arg1=#1,
      arg2 handle from key=#1/interval
    }
  }
}
...
\tikzdatavisualizationset{%
  new axis/.style={
    ...
    new object={
      when=after survey,
      store=/tikz/data visualization/#1/attribute mapper,
      class=attribute mapper,
      arg1 from key=#1/source,%
      arg2 from key=#1/source min,%
      arg3 from key=#1/source max,%
      arg4 from key=#1/target,%
      arg5 from key=#1/target min,%
      arg6 from key=#1/target max,%
      arg7 from key=#1/function
    },
    #1/source/.initial=#1,
