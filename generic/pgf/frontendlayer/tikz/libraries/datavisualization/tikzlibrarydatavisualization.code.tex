...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.20 2010/02/22 22:49:21 tantau Exp $
...
\def\tikz@lib@dv@typeset{%
  ...
  \pgfkeysvalueof{/tikz/data visualization/typesetter}{\tikz@lib@dv@typesetnum}%
}
...
\tikzdatavisualizationset{
  ...
  @about method/.initial=,
  linear at positions/.style={
    @compute default at positions=\tikz@lib@dv@linear@at@positions,
    @about method=\tikz@lib@dv@about@linear
  },
  log at positions/.style={
    @compute default at positions=\tikz@lib@dv@log@at@positions,
    @about method=\tikz@lib@dv@about@log,
  },
  linear at positions
}

\def\tikz@lib@dv@linear@at@positions{%
  ...
  \pgfkeysgetvalue{/tikz/data visualization/step}\tikz@temp
  \pgfdvmathenter{\tikz@dv@lib@step}{\tikz@temp}
  % Compute start:
...
\def\tikz@lib@dv@log@at@positions{%
  % Gather interesting values
  \tikz@lib@dv@mapper.get in range interval()%
  \pgfdvinrangeinterval.get min and max()%
...
\tikzdatavisualizationset{
  about/.style={@compute default step=\tikz@lib@dv@about{#1},step=},
...
\def\tikz@lib@dv@about#1{\pgfkeysvalueof{/tikz/data visualization/@about method}{#1}}
...
\tikzdatavisualizationset{
  school book axes/.style={
    ...
    x axis={
      ...
      visualize ticks={common={y axis={goto=0},direction axis=y axis},major={tick text at low}},
    ...
    y axis={
      ...
      visualize ticks={common={x axis={goto=0},direction axis=x axis},major={tick text at low}},
