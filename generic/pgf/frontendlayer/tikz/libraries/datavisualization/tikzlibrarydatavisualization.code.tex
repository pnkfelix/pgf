...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.10 2008/12/09 00:12:10 tantau Exp $
...
\tikzset{
  every tick text node/.style={font=\pgfutil@font@footnotesize}
}
...
\def\tikz@dv@handle@tick#1{%
  \pgfextra{
    ...
    \else
      \def\tikz@dv@tick@marshal{node[anchor=#1,every tick text node/.try,}%
...
\tikzdatavisualizationset{
  school book plot/.style={
    xy Cartesian,
    x axis={
      visualize={y axis={goto=0},styling/.style=->},
      visualize ticks={common={y axis={goto=0},ticks direction axis=y axis},only ticks={tick text at min extend}},
    },
    y axis={
      visualize={x axis={goto=0},styling/.style=->},
      visualize ticks={common={x axis={goto=0},ticks direction axis=x axis},only ticks={tick text at min extend}},
    },
    new line plot,
  ...
  school book 3d plot/.style={
    xyz Cartesian,
    x axis={
      visualize={y axis={goto=0},z axis={goto=0},styling/.style=->},
      visualize ticks={common={y axis={goto=0},z axis={goto=0},ticks direction axis=y axis},only ticks={tick text at min extend}},
%      visualize ticks={common={y axis={goto=0},z axis={goto=0},ticks direction axis=z axis}},
    },
    y axis={
      visualize={x axis={goto=0},z axis={goto=0},styling/.style=->},
      visualize ticks={common={x axis={goto=0},z axis={goto=0},ticks direction axis=x axis},only ticks={tick text at min extend}},
%      visualize ticks={common={x axis={goto=0},z axis={goto=0},ticks direction axis=z axis}},
    },
    z axis={
      visualize={x axis={goto=0},y axis={goto=0},styling/.style=->},
      visualize ticks={common={x axis={goto=0},y axis={goto=0},ticks direction axis=x axis},only ticks={tick text at min extend}},
%      visualize ticks={common={x axis={goto=0},y axis={goto=0},ticks direction axis=y axis}}
    },
    new line plot,
    every school book plot/.try
  }
...
\tikzdatavisualizationset{
  ...
  scientific plot/.style={
    ...
    x axis={
      ...
      visualize ticks={common={y axis={goto=min},ticks direction axis=y axis,max extend=0pt},only ticks={tick text at min extend}},
      visualize ticks={common={y axis={goto=max},ticks direction axis=y axis,min extend=0pt}},
    },
    y axis={
      length=\pgfkeysvalueof{/tikz/data visualization/scientific plot/height},
      visualize={x axis={goto=min}},
      visualize={x axis={goto=max}},
      visualize ticks={common={x axis={goto=min},ticks direction axis=x axis,max extend=0pt},only ticks={tick text at min extend}},
      visualize ticks={common={x axis={goto=max},ticks direction axis=x axis,min extend=0pt}},
    },
    new line plot,
  },
