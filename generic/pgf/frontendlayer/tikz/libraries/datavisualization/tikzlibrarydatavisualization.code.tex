...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.24 2010/05/31 10:11:22 tantau Exp $
...
\pgfkeys{
  ...
  label/.style={/tikz/data visualization/visualizers/\tikz@visualizer/label/.initial=#1},
  style/.style={/tikz/data visualization/visualizers/\tikz@visualizer/style/.style={#1}},
}
...
\tikzdatavisualizationset{
  new label visualizer/.style={
    new object={
      when=after survey,
      store=/tikz/data visualization/visualizers/#1/label,
