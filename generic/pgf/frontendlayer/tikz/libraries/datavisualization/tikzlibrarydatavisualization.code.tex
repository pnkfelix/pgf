...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.16 2009/02/13 11:28:53 tantau Exp $
...
\def\tikz@lib@dv@default@action#1#2#3{%
  {%
    ...
    \pgfkeysgetvalue{/tikz/data visualization/@compute default ats}\tikz@temp%
    \ifx\tikz@temp\pgfutil@empty%
      \global\let\tikz@marshal\pgfutil@empty%
    \else
      \tikzdatavisualizationset{@compute default step}%  
      \tikzdatavisualizationset{@compute default ats}%  
...
\tikzdatavisualizationset{
  ...
  @compute default ats/.initial=,
  linear ats/.style={@compute default ats=\tikz@lib@dv@linear}
}
