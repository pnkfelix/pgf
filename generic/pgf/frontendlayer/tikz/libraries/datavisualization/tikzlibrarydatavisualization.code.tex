...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.12 2008/12/17 22:48:46 tantau Exp $
...
\tikzdatavisualizationset{%
  ...
  at/.code=\expandafter\def\expandafter\tikz@dv@at@list\expandafter{\tikz@dv@at@list,#1},
  value/.initial=,
  pos/.initial=,
  auto/.style={at={0,1}},
  ...
  clean ticks/.style={/tikz/every tick node/.append style={fill=white}},
  % Default grid styles
  only grid/.initial=,
  ...
  \else
    {%
      \scope[/tikz/data visualization/.cd,every tick/.try,every #1/.try,#3]
        ...
        \foreach \tikz@dv@tick@pos/\tikz@dv@tick@text in \tikz@dv@at@list 
        {
...
\tikzdatavisualizationset{
  scientific axes/width/.initial=125pt,
  scientific axes/height/.initial=0.618*125pt,% golden ratio...
