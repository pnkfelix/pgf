...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.4 2008/07/25 16:29:35 tantau Exp $
...
\tikzdatavisualizationset{%
  new axis/.style={
    ...
    #1/ln/.style={
      #1/function=\pgfmathparse{ln(\pgfvalue)},
      #1/scaling default=1 at 0pt and 10 at 1cm,
    }
  }
}
