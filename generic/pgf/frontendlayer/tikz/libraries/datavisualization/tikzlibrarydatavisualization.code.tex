...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/libraries/datavisualization/tikzlibrarydatavisualization.code.tex,v 1.28 2010/08/24 21:28:58 tantau Exp $
...
\tikzdatavisualizationset{
  visualize as line/.style={
    ...
    new visualizer={#1}{%
      every path/.style={draw,color=visualizer color},
