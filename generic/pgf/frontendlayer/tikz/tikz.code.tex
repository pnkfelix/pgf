...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.8 2008/01/17 20:09:16 tantau Exp $
...
% Snakes are in a lib:
\tikzset{snake/.code=\PackageError{tikz}{You need to say \string\usetikzlibrary{decorations}}{}}

% Decorations are in a lib
\tikzset{decoration/.code=\PackageError{tikz}{You need to say \string\usetikzlibrary{decorations}}{},
         meta-decoration/.style=decoration,
         decorate/.is if=tikz@decoratepath}
...
\def\tikz@lib@decoration[#1]#2{%
  \PackageError{tikz}{You need to say \string\usetikzlibrary{decorations} to use decorations}{}%
  \tikz@scan@next@command%
}
