...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.42 2008/06/16 19:45:21 tantau Exp $
...
\def\tikz@go{%
  \PackageError{tikz}{You need to say \string\usetikzlibrary{turtle} to
    use the go path operation}{}
}

\def\tikz@gchar{\pgfutil@ifnextchar r{\tikz@grid}{\tikz@go}}
