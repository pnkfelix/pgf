...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.20 2008/02/06 16:14:28 tantau Exp $
...
\def\tikz@of#1#2{%
  ...
  \tikz@addtransform{\pgftransformshift{\pgfpointpolar{#2}{\tikz@extracted@node@distance}}}%
...
\def\tikz@fig@main{\tikz@node@begin@hook\afterassignment\tikz@@fig@main\let\next=}
\def\tikz@@fig@main{%
