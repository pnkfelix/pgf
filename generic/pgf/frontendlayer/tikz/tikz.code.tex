...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.69 2010/06/30 10:25:08 ludewich Exp $
...
\tikzoption{hbaseline}[0pt]{\pgfutil@ifnextchar({\tikz@hbaseline@coordinate}{\tikz@hbaseline@simple}#1\@nil}%)
\def\tikz@hbaseline@simple#1\@nil{\pgfsethbaseline{#1}}
\def\tikz@hbaseline@coordinate#1\@nil{\pgfsethbaselinepointlater{\tikz@scan@one@point\pgfutil@firstofone#1}}
