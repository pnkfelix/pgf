...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.46 2008/06/18 23:34:49 tantau Exp $
...
\def\tikz@endscope{%
  ...
  \else%
      ...
      \global\let\tikz@scope@save@bordername\tikz@shapeborder@name%
      \global\let\tikz@moveto@waiting@saved\tikz@moveto@waiting%
      \iftikz@shapeborder\aftergroup\tikz@shapebordertrue\else\aftergroup\tikz@shapeborderfalse\fi%
    \endgroup%
    \let\tikz@shapeborder@name\tikz@scope@save@bordername%  
    \let\tikz@moveto@waiting\tikz@moveto@waiting@saved%
