...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.44 2008/06/17 12:03:35 tantau Exp $
...
% After path options
\tikzset{after option path/.code=\expandafter\def\expandafter\tikz@after@options\expandafter{\tikz@after@options#1}}
...
\def\tikz@parse@options#1]{%
  \let\tikz@after@options\pgfutil@empty%
  \tikzset{#1}%
