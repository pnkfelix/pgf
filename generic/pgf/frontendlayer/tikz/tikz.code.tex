...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.4 2008/01/14 15:22:36 tantau Exp $
...
\tikzset{decoration/.code=\PackageError{tikz}{You need to load the decorations library}{},
         meta decoration/.code=\PackageError{tikz}{You need to load the decorations library}{}}
