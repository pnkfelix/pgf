...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/frontendlayer/tikz/tikz.code.tex,v 1.50 2008/07/14 10:30:36 tantau Exp $
...
\tikzset{
  ...
  align/.is choice,
  align/left/.style  ={text ragged,node halign header={##\hfil\cr}},
  align/flush left/.style  ={text badly ragged,node halign header={##\hfil\cr}},
  align/right/.style ={text ragged left,node halign header={\hfil##\cr}},
  align/flush right/.style ={text badly ragged left,node halign header={\hfil##\cr}},
  align/center/.style={text centered,node halign header={\hfil##\hfil\cr}},
  align/flush center/.style={text badly centered,node halign header={\hfil##\hfil\cr}},
  align/justify/.style ={text justified,node halign header={##\hfil\cr}},
...
\def\tikz@halign@check{%
  ...
  \iftikz@do@align%
    % Bingo
    \setbox\tikz@align@aligned@box=\box\voidb@x% void
...
\def\tikz@align@end@check{%
  ...
  \else%
    \setbox\tikz@align@aligned@box=\vbox{\expandafter\halign\expandafter{\tikz@align@header%
