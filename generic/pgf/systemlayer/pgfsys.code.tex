...
\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.36 2010/06/30 10:25:08 ludewich Exp $
...
\def\pgfsys@typesetpicturebox#1{%
  ...
  %
  \pgf@xa=\pgf@hshift@baseline\relax%
  %
  ...
  \dp#1=0pt%
  \leavevmode%
  \ifdim\pgf@xa=0pt \else\hskip\pgf@xa\fi
  \raise-\pgf@ya\box#1%
}
