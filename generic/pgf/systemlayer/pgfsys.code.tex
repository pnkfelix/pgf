\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.15 2006/10/01 14:46:00 tantau Exp $
...
% Sets #2 to a pgfpoint macro that returns the position #1. Typically,
% getting this position requires two runs of TeX. On the first run,
% the macro will be set to \relax, indicating that the position is not
% available. 
