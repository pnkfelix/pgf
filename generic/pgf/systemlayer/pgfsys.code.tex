\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/systemlayer/pgfsys.code.tex,v 1.3 2005/07/10 17:54:32 tantau Exp $
...
% Called at the beginning of a pgfpicture. 
%
% (#1,#2) is the lower left corner of the picture, (#3,#4) is the
% upper right corner.
%
% Note that the implementation of this command should *not* insert a
% box of the appropriate size. This will be done by the caller. The
% arguments are just a ``hint'' of the size the picture has. This is
% currently useful for svg.
