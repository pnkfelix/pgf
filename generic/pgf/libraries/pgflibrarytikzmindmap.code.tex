\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibrarytikzmindmap.code.tex,v 1.7 2006/09/27 17:07:24 tantau Exp $
...
\tikzstyle{mindmap}=
  [fill,draw,very thick,outer sep=0pt,inner sep=1pt,%
   ...
   style=every mindmap,text centered%
  ]
\tikzstyle{every mindmap}=[]

\tikzstyle{root concept}=   [minimum size=4cm,font=\large]
...
\tikzstyle{large mindmap}=
  [%
  set style={{root concept}=[minimum size=5.6cm,font=\Large]},
...
\tikzstyle{huge mindmap}=
  [%
  set style={{root concept}=[minimum size=8cm,font=\huge]},
  set style={{level 1 concept}+=[%
    minimum size=4.5cm,
    level distance=10cm,
    text width=4cm,
