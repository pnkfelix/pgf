...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibrarytikzmindmap.code.tex,v 1.20 2007/03/09 17:49:32 tantau Exp $
...
\pgfdeclaresnake{circle connection bar}{initial}
{
  \state{initial}[width=0pt,next state=bar]
  {
    ...
    \pgfmathsetlength\@tempdima{\pgfsnakecirclestartradius}
    \pgfmathsetlength\@tempdimb{\pgfsnakesegmentamplitude}
    \pgfpathcurveto
    {\pgfpointadd
      {\pgfpointpolar{-\pgfsnakesegmentangle}{\pgfsnakecirclestartradius}}
      {\pgfpointpolar{\the\pgfutil@tempcnta}{.25\@tempdima}}}
    {\pgfqpoint{1.25\@tempdima}{-.5\@tempdimb}}
    {\pgfqpoint{1.5\@tempdima}{-.5\@tempdimb}}
  ...
  {
    \pgfmathsetlength\@tempdima{\pgfsnakecirclestartradius}%
    \pgfmathsetlength\@tempdimb{\pgfsnakecircleendradius}%
    \pgfmathsetlength\pgf@xc{\pgfsnakesegmentamplitude}%
    \pgfpathrectangle
    {\pgfqpoint{.5\@tempdima}{-.5\pgf@xc}}
  ...
  \state{end}[width=0pt,next state=final]
  {
    ...
    \pgfutil@tempcnta=-\pgfsnakesegmentangle\relax
    \advance\pgfutil@tempcnta by90\relax
    \pgfmathsetlength\@tempdima{\pgfsnakecircleendradius}
    \pgfmathsetlength\@tempdimb{\pgfsnakesegmentamplitude}%
    \pgfpathcurveto
    {\pgfpointadd
