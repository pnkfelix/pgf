\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/pgflibrarysnakes.code.tex,v 1.2 2005/09/06 08:12:49 tantau Exp $
...
{
  \state{coil}[switch if less than=1.5\pgfsnakesegmentlength+\pgfsnakesegmentaspect\pgfsnakesegmentamplitude+\pgfsnakesegmentaspect\pgfsnakesegmentamplitude to last,
  ...
  \state{last}[width=.5\pgfsnakesegmentlength+\pgfsnakesegmentaspect\pgfsnakesegmentamplitude+\pgfsnakesegmentaspect\pgfsnakesegmentamplitude,next state=final]
  {
    \pgfpathcurveto
    {\pgfpoint@oncoil{0    }{ 0.555}{1}}
    {\pgfpoint@oncoil{0.445}{ 1    }{2}}
