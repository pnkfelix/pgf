...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibraryshapes.arrows.code.tex,v 1.2 2007/10/28 15:24:30 vibrovski Exp $
...
\pgfkeys{/pgf/single arrow tip angle/.initial=90}

\pgfkeys{/pgf/single arrow head extend/.initial=1.5ex}

\pgfkeys{/pgf/single arrow head indent/.initial=0pt}
...
\pgfkeys{/pgf/double arrow tip angle/.initial=90}

\pgfkeys{/pgf/double arrow head extend/.initial=1.5ex}

\pgfkeys{/pgf/double arrow head indent/.initial=0ex}
...
\def\pgf@lib@arrowbox@parsearrows#1{%
	\pgfkeysalso{%
		/pgf/arrow box west arrow=0pt,
		/pgf/arrow box east arrow=0pt,
		/pgf/arrow box south arrow=0pt,
		/pgf/arrow box north arrow=0pt
	}%
...
\pgfkeys{/pgf/.cd,
	...
	arrow box arrows/.code={\pgf@lib@arrowbox@parsearrows{#1}}
}	
