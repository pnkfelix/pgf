...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibraryshapes.geometric.code.tex,v 1.12 2007/07/23 21:23:14 tantau Exp $
...
% \pgfsetcircularsectorangle
%
\def\pgfsetcircularsectorangle#1{\pgfmathsetmacro\pgfcircularsectorangle{#1}}
\pgfsetcircularsectorangle{60}
...
\pgfdeclareshape{circular sector}{%
	\savedmacro\installcircularsectorparameters{%
		...
		%
		\pgfmathmod@{\pgfcircularsectorangle}{360}%
		\ifdim\pgfmathresult pt<0pt\relax%
			\pgfmathadd@{\pgfmathresult}{360}%
		\fi%
		\let\angle\pgfmathresult%
