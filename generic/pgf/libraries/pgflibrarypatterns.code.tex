\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/pgflibrarypatterns.code.tex,v 1.3 2006/03/15 22:50:44 tantau Exp $
...
\pgfdeclarepatternformonly{fivepointed stars}{\pgfpointorigin}{\pgfpoint{1cm}{1cm}}{\pgfpoint{3mm}{3mm}}%
{
...
\pgfdeclarepatternformonly{sixpointed stars}{\pgfpointorigin}{\pgfpoint{1cm}{1cm}}{\pgfpoint{3mm}{3mm}}%
{
  \pgftransformshift{\pgfpoint{1mm}{1mm}}
