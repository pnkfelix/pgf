...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibrarytikzcalendar.code.tex,v 1.7 2007/02/10 17:50:20 tantau Exp $
  ...
  execute before current date scope={%
    \ifdate{day of month=1}{\ifdate{equals=\pgfcalendarbeginiso}{}
      {%
        ...
        \setlength{\pgf@y}{\tikz@lib@cal@month@yshift}%
...
\tikzstyle{months left horizontal}=[%
  execute before current date scope={\ifdate{day of month=1}{\tikzmonthcode}{}},
...
execute before current date scope={\ifdate{day of month=1}{%
    {%
...
\tikzstyle{months below centered}=[%
  execute before current date scope={%
    \ifdate{day of month=1}{%
      {
        \setlength{\pgf@xa}{\tikz@lib@cal@xshift}%
