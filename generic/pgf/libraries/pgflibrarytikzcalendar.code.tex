...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibrarytikzcalendar.code.tex,v 1.11 2007/02/13 10:27:24 tantau Exp $
...
\tikzstyle{day list left}=[%
  execute before day scope={
    \ifdate{day of month=1}{\ifdate{equals=\pgfcalendarbeginiso}{}
      {%
        % On first of month, except when first date in calendar.
        \setlength{\pgf@x}{\tikz@lib@cal@month@xshift}
