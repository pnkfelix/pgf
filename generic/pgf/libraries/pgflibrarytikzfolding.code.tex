...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibrarytikzfolding.code.tex,v 1.2 2007/02/12 18:24:34 tantau Exp $
...
\tikzoption{folding line length}{\setlength\tikz@lib@fold@length{#1}}
\newdimen\tikz@lib@fold@length
\tikz@lib@fold@length=2cm


\def\tikz@lib@fold@pentagon#1#2#3#4#5#6{%
  \begin{scope}[xshift=.5\tikz@lib@fold@length,yshift=0.6881909602355868\tikz@lib@fold@length]
    #1
  \end{scope}
