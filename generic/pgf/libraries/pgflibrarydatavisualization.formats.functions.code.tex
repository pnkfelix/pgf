...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibrarydatavisualization.formats.functions.code.tex,v 1.3 2008/06/09 15:57:30 tantau Exp $
...
{%
  ...
  \pgf@lib@dv@vars\pgfdatapoint\pgfutil@gobble\pgf@stop%
}
