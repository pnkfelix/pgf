...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibrarytikz3d.code.tex,v 1.4 2007/07/12 21:54:09 tantau Exp $
...
{%
  \pgfset{/tikz/cs/.use as path,angle=0,radius=0,z=0,#1}%
  \pgfpointcylindrical{\tikz@cs@angle}{\tikz@cs@radius}{\tikz@cs@z}%
}

\tikzdeclarecoordinatesystem{xyz spherical}
{%
  \pgfset{/tikz/cs/.use as path,angle=0,radius=0,latitude=0,longitude=0,#1}%
