\ProvidesPackageRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibrarytikztrees.code.tex,v 1.2 2005/08/29 22:11:20 tantau Exp $
...
\tikzstyle{grow downward leftward}=[grow via three points=%
...
\tikzstyle{grow upward}=[grow via three points=%
  {one child at (0pt,\tikzleveldistance) and 
   two children at (-.5\tikzsiblingdistance,\tikzleveldistance) and (.5\tikzsiblingdistance,\tikzleveldistance)}]

\tikzstyle{grow upward leftward}=[grow via three points=%
  {one child at (0pt,\tikzleveldistance) and 
   two children at (.5\tikzsiblingdistance,\tikzleveldistance) and (-.5\tikzsiblingdistance,\tikzleveldistance)}]

\tikzstyle{grow leftward}=[grow via three points=%
...
\tikzstyle{grow leftward upward}=[grow via three points=%
  {one child at (-\tikzleveldistance,0pt) and 
   two children at (-\tikzleveldistance,-.5\tikzsiblingdistance) and (-\tikzleveldistance,.5\tikzsiblingdistance)}]

\tikzstyle{grow rightward}=[grow via three points=%
  {one child at (\tikzleveldistance,0pt) and 
   two children at (\tikzleveldistance,.5\tikzsiblingdistance) and (\tikzleveldistance,-.5\tikzsiblingdistance)}]

\tikzstyle{grow rightward upward}=[grow via three points=%
  {one child at (\tikzleveldistance,0pt) and 
   two children at (\tikzleveldistance,-.5\tikzsiblingdistance) and (\tikzleveldistance,.5\tikzsiblingdistance)}]
...
\tikzstyle{grow cyclic}=[grow function=\tikz@grow@circle]
