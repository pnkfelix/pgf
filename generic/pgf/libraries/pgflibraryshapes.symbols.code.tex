...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibraryshapes.symbols.code.tex,v 1.12 2007/11/24 09:26:17 vibrovski Exp $
...
\def\pgf@lib@shapes@tape@inandout{in and out}
\def\pgf@lib@shapes@tape@outandin{out and in}
\def\pgf@lib@shapes@tape@none{none}
...
\pgfdeclareshape{tape}{%
	\savedmacro\gettapepoints{%
		...
		%
		\c@pgf@countb0\relax%
		\ifx\north\pgf@lib@shapes@tape@none%
		\else%
			\advance\c@pgf@countb1\relax%
		\fi%
		\ifx\south\pgf@lib@shapes@tape@none%
		\else%
			\advance\c@pgf@countb1\relax%
		\fi%
		\pgf@y\pgf@ya%
		...
		\pgfextract@process\northeastanchor{%
			\pgfpointadd{\northeast}{%
				\ifx\north\pgf@lib@shapes@tape@outandin%
					\pgfmathadd@{45}{\halfgradientangle}%
					\let\miterangle\pgfmathresult%
					\pgfqpointpolar{\miterangle}{\inmiterlength}%
				\else%
					\ifx\north\pgf@lib@shapes@tape@inandout%
						\pgfmathsubtract@{45}{\halfgradientangle}%
						\let\miterangle\pgfmathresult%
		...
		\pgfextract@process\southwestanchor{%
			\pgfpointadd{\southwest}{%
				\ifx\south\pgf@lib@shapes@tape@outandin%
					\pgfmathadd@{225}{\halfgradientangle}%
					\let\miterangle\pgfmathresult%
					\pgfqpointpolar{\miterangle}{\inmiterlength}%
				\else%
					\ifx\south\pgf@lib@shapes@tape@inandout%
