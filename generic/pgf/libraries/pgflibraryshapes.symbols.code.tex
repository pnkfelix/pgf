...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibraryshapes.symbols.code.tex,v 1.8 2007/11/08 19:37:34 vibrovski Exp $
...
\pgfdeclareshape{cloud}{%
	\savedmacro\getradii{%
		...
		\edef\xinnerradius{\the\pgf@x}%
		\edef\yinnerradius{\the\pgf@y}%
		\edef\xdefaultinnerradius{\the\pgf@x}%
		\edef\ydefaultinnerradius{\the\pgf@y}%
		%
		% Get the larger of the outer sep.
		%	
		\pgfmathsetlength\pgf@x{\pgfkeysvalueof{/pgf/outer xsep}}%
		...
		\pgf@yb.5\pgf@yb%
		\ifdim\yinnerradius<\pgf@yb%
			\edef\yinnerradius{\the\pgf@yb}%
		\fi%
		%
		...
		\pgf@xb.5\pgf@xb%
		\ifdim\xinnerradius<\pgf@xb%
			\edef\xinnerradius{\the\pgf@xb}%
		\fi%
		%
		\addtosavedmacro\xinnerradius%
		\addtosavedmacro\yinnerradius%
	...
	\saveddimen\minimumwidth{%
		\pgfmathsetlength\pgf@x{\pgfkeysvalueof{/pgf/minimum width}}%
	}%
	\saveddimen\minimumheight{%
		\pgfmathsetlength\pgf@x{\pgfkeysvalueof{/pgf/minimum height}}%
	}%
	%
