...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/datavisualization/pgflibrarydatavisualization.formats.functions.code.tex,v 1.1 2008/06/16 19:45:21 tantau Exp $
...
\def\pgf@lib@dv@var var #1=[#2:#3]{%
  \pgfutil@ifnextchar s{%
    ...
    \expandafter\def\expandafter\pgf@lib@dv@parsed\expandafter{%
      \pgf@lib@dv@parsed\pgf@lib@dv@samples@var{#1}{#2}{#3}{\pgfkeysvalueof{/pgf/data visualization/samples}}}%
