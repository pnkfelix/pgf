...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/pgflibraryplothandlers.code.tex,v 1.12 2008/05/17 08:13:03 ludewich Exp $
...
\def\pgfplotxzerolevelstreamconstant#1{%
	...
	\def\pgf@plotxzerolevelstreamstart{%
		...
		\gdef\pgf@plotxzerolevelstreamnext{\pgf@x=\pgfplotxzerolevelstreamconstant@val\relax}%
	}%
}%
...
\def\pgfplotyzerolevelstreamconstant#1{%
	...
	\def\pgf@plotyzerolevelstreamstart{%
		...
		\gdef\pgf@plotyzerolevelstreamnext{\pgf@x=\pgfplotyzerolevelstreamconstant@val\relax}%
	}%
}%
...
% Assigns the (public) macro \pgfplotbarwidth.
\def\pgfsetplotbarwidth#1{\pgfmathparse{#1}\edef\pgfplotbarwidth{\pgfmathresult pt}}%
\pgfsetplotbarwidth{10pt}%
