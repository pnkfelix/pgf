\ProvidesPackageRCS $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/pgflibraryplothandlers.code.tex,v 1.1 2005/06/29 12:14:04 tantau Exp $
...
%
% #1 = tension of curves; default is 0.15. The correct value
%      depends on the curvature of the curves.
%
% Example:
%
% \pgfsetplottension{0.2}

\def\pgfsetplottension#1{\def\pgf@plottension{#1}}
\pgfsetplottension{0.15}
