...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/pgflibraryplothandlers.code.tex,v 1.10 2008/04/25 22:20:21 ludewich Exp $
...
\def\pgfsetplotbarwidth#1{\def\pgf@plot@bar@width{#1}}%
...
\def\pgf@plot@ybar@handler#1{%
  \pgf@process{#1}%
  \pgf@ya=\pgf@y
  \expandafter\pgf@xb\pgf@plot@bar@width\relax
  \pgf@xc=\pgf@x
  \advance\pgf@xc by-.5\pgf@xb
  \pgfpathrectangle
	{\pgfqpoint{\pgf@xc}{0pt}}%
