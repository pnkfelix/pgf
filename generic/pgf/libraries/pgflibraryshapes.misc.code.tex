...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/Attic/pgflibraryshapes.misc.code.tex,v 1.8 2007/11/10 09:16:33 vibrovski Exp $
...
\pgfkeys{/pgf/.cd,
	rounded rectangle left arc/.initial=convex,%
	rounded rectangle right arc/.initial=convex,%
...
\pgfdeclareshape{rounded rectangle}{
	\savedmacro\leftarc{%
		\edef\leftarc{\pgfkeysvalueof{/pgf/rounded rectangle left arc}}%
	}
	\savedmacro\rightarc{%
		\edef\rightarc{\pgfkeysvalueof{/pgf/rounded rectangle right arc}}%
	}
