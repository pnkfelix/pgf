...
\ProvidesFileRCS[v\pgfversion] $Header: /cvsroot/pgf/pgf/generic/pgf/libraries/pgflibrarysvg.path.code.tex,v 1.2 2009/01/12 16:18:21 tantau Exp $
...
{
  \pgf@lib@svg@finish@prev
  \let\pgf@lib@svg@finish@prev=\pgf@lib@svg@hlineto
  \pgfparserswitch{num}
  \let\pgf@lib@svg@num=\pgfutil@empty%
}

\def\pgf@lib@svg@hlineto{%
  \ifx\pgf@lib@svg@num\pgfutil@empty% nothing read
  \else%
    \pgf@lib@svg@last@x=\pgf@lib@svg@num pt%
    \pgfpathlineto{\pgfqpoint{\pgf@lib@svg@last@x}{\pgf@lib@svg@last@y}}%
    \let\pgf@lib@svg@num=\pgfutil@empty%
  \fi
}
...
{
  \pgf@lib@svg@finish@prev
  \let\pgf@lib@svg@finish@prev=\pgf@lib@svg@hlineto@rel
  \pgfparserswitch{num}
  \let\pgf@lib@svg@num=\pgfutil@empty%
}
...
\def\pgf@lib@svg@hlineto@rel{%
  \ifx\pgf@lib@svg@num\pgfutil@empty% nothing read
  \else%
    \advance\pgf@lib@svg@last@x by\pgf@lib@svg@num pt%
    \pgfpathlineto{\pgfqpoint{\pgf@lib@svg@last@x}{\pgf@lib@svg@last@y}}%
    \let\pgf@lib@svg@num=\pgfutil@empty%
  \fi
}
...
{
  \pgf@lib@svg@finish@prev
  \let\pgf@lib@svg@finish@prev=\pgf@lib@svg@vlineto
  \pgfparserswitch{num}
  \let\pgf@lib@svg@num=\pgfutil@empty%
}
...
{
  \pgf@lib@svg@finish@prev
  \let\pgf@lib@svg@finish@prev=\pgf@lib@svg@vlineto@rel
  \pgfparserswitch{num}
  \let\pgf@lib@svg@num=\pgfutil@empty%
}
...
{
...  \pgf@lib@svg@finish@prev
  \let\pgf@lib@svg@finish@prev=\pgf@lib@svg@curveto
  \pgfparserswitch{num}
  \let\pgf@lib@svg@num=\pgfutil@empty%
}
