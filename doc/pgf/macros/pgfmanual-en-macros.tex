% $Header: /cvsroot/pgf/pgf/doc/pgf/macros/Attic/pgfmanual-en-macros.tex,v 1.2 2005/09/07 22:11:17 tantau Exp $
...
\newenvironment{pathoperation}[2]{
  \begin{pgfmanualentry}
    \pgfmanualentryheadline{\textcolor{gray}{{\ttfamily\char`\\path}\
        \ \dots}
      \declare{\texttt{#1}}#2\ \textcolor{gray}{\dots\texttt{;}}}%
